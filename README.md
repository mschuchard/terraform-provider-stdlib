...
This repository additionally does accept and welcome feature requests for e.g. additional functions or enhancements to current functions in the Github issue tracker.
